...
public class EditCommercePresenter implements IEditUserPresenter {

    private IEditUserView mView;

    public EditCommercePresenter(IEditUserView view) {
        mView = view;
    }
    ...
    private boolean validateFields(String username, String phoneNumber, String email) {
